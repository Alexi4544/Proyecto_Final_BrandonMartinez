...
Partial Class San_Marcos
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(San_Marcos))
        Label1 = New Label()
        ...
        Label1.TabIndex = 1
        Label1.Text = "San Marcos"
        ' 
        ' PictureBox1
        ' 
        PictureBox1.Image = CType(resources.GetObject("PictureBox1.Image"), Image)
        PictureBox1.Location = New Point(135, 68)
        ...
        PictureBox2.Location = New Point(464, 68)
